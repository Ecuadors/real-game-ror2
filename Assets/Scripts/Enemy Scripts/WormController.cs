...
public class WormController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        scaleModifier = Random.Range(-0.6f, 0.6f);
        speedModifier = Random.Range(3f, 4.8f);
        ...
        healthbar.maxValue = Random.Range((difficultyScaling*8f + 22f), (difficultyScaling*8f + 150f));
    ...
    void OnEnemyDeath()
    {
        ...
        if (Random.Range(0, 18) <= ((ItemSpawnChance * 2f) + 5))
        {
            itemSpawned = true;
